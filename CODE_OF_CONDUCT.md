...
1. Respecting the **purpose of our community**, our activities, and our practices
   for collaborating and contributing.
...
possible violation, contact the repository maintainer by opening a GitHub issue
or by using the maintainer contact information listed on the repository owner's
GitHub profile. If a public issue would disclose private or sensitive
information, use a private contact method and include only the context needed for
the maintainer to understand and respond to the report.
...
1. **Warning**
   - _Event:_ A violation involving a single incident or series of incidents.
   - _Consequence:_ A private, written warning from the community moderators.
...
4. **Permanent Ban**
   ...
   - _Consequence:_ Access to all community spaces, tools, and communication
   ...
   - _Repair:_ There is no possible repair in cases of this severity.
